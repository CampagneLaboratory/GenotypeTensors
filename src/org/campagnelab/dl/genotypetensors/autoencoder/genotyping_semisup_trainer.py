...
class GenotypingSemiSupTrainer(CommonTrainer):
    ...
    def train_semisup(self, epoch):
        ...
        data_provider = DataProvider(iterator=zip(train_loader_subset, unlabeled_loader),is_cuda=self.use_cuda,
    ...
    def test_semi_sup(self, epoch):
        ...
        data_provider = DataProvider(iterator=zip(validation_loader_subset), is_cuda=self.use_cuda,
