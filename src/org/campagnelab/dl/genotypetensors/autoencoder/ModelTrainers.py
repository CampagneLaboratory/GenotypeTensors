...
def define_train_auto_encoder_parser():
    ...
    parser.add_argument("--struct-num-iterations", type=int, default=5, help="Maximum number of times a mini-batch is (re)used when training. Set to 1 to use a mini-batch only once per epoch.")
    return parser
...
def configure_model_trainer(train_args, train_problem, train_device, class_frequencies=None):
    ...
    if train_args.mode == "struct_genotyping":
        ...
        model_trainer = GenotypingADDATrainer(args=train_args, problem=train_problem, device=train_device)
        model_trainer.init_model(create_model_function=(
        ...
        model_trainer = GenotypingAutoEncoderTrainer(args=train_args, problem=train_problem, device=train_device)
        ...
        model_trainer = SomaticTrainer(args=train_args, problem=train_problem, device=train_device)
        ...
        model_trainer = GenotypingSemiSupTrainer(args=train_args, problem=train_problem, device=train_device)
        ...
        model_trainer = GenotypingSupervisedTrainer(args=train_args, problem=train_problem, device=train_device)
        ...
        model_trainer = AdversarialAutoencoderTrainer(args=train_args, problem=train_problem, device=train_device)
        ...
        model_trainer = AdversarialCrossencoderTrainer(args=train_args, problem=train_problem, device=train_device)
        ...
        model_trainer = GenotypingSupervisedMixupTrainer(args=train_args, problem=train_problem, device=train_device)
